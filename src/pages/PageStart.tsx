    ...
    return (
        <div className='h-dvh flex flex-col bg-slate-950'>
            ...
            <div className='grid w-full max-w-[2560px] h-full overflow-hidden relative mx-auto'>
                ...
                <div className='col-start-1 row-start-1 xl:mx-0 xl:w-1/2 md:h-2/3 md:w-1/2 sm:w-full px-6 md:pl-12 md:pr-0 text-left flex flex-col justify-center gap-2 '>
                ...
                <div className='col-start-1 row-start-1 top-0 left-0 w-full h-min mt-auto flex items-end md:visible invisible' >
